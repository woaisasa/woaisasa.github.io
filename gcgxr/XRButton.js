	...
	static createButton( renderer, sessionInit = {} ) {
		...
		if ( 'xr' in navigator ) {
			...
			if ( window.isSecureContext === false ) {
				...
				message.innerHTML = 'WEBXR必须使用https'; // TODO Improve message

			} else {

				message.href = 'https://immersiveweb.dev/';
				message.innerHTML = 'WEBXR不支持';
